...
% title
text(0,1.3,tle,'horizontalalignment','center','fontweight','bold','Fontsize',10);
...
% plot axes markers
inc = .25:.25:1; mk = .025 * ones(1,4); tx = 4 * mk; tl = 0:.25:1;
...
% 				'fontsize',8);
		...
		if ang(ii) >= pi
			set(temp,'HorizontalAlignment','right','Fontsize',10)
		end
	end
	% label each axis
...
% apply the legend
temp = legend(o,leg,'location','best','Fontsize',14);
